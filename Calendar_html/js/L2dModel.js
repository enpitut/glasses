//============================================================
//============================================================
//  class L2dModel     extends L2DBaseModel         
//============================================================
//============================================================
function L2dModel()
{
...
L2dModel.prototype = new L2DBaseModel();

/*
 * モデルを初期化する
 */
L2dModel.prototype.load = function(gl, modelSettingPath, callback)
{
			...
			for (var i = 0; i < thisRef.modelSetting.getTextureNum(); i++)
			{
				...
				thisRef.loadTexture(i, texPaths, function() {
                    ...
                    if( thisRef.isTexLoaded ) {
                        ...
                        // アイドリングはあらかじめ読み込んでおく。
                        thisRef.preloadMotionGroup(L2dDefine.MOTION_GROUP_IDLE);
 ...
 * GCだけで解放されないメモリを解放
 */
L2dModel.prototype.release = function(gl)
{
 ...
 * モーションファイルをあらかじめ読み込む
 */
L2dModel.prototype.preloadMotionGroup = function(name)
{
    var thisRef = this;
...
L2dModel.prototype.update = function()
{
    // console.log("--> L2dModel.update()");

    if(this.live2DModel == null) 
    {
        if (L2dDefine.DEBUG_LOG) console.error("Failed to update.");
    ...
    if (this.mainMotionManager.isFinished())
    {
        ...
        this.startRandomMotion(L2dDefine.MOTION_GROUP_IDLE, L2dDefine.PRIORITY_IDLE);
    }
 ...
 * 表情をランダムに切り替える
 */
L2dModel.prototype.setRandomExpression = function()
{
    var tmp = [];
 ...
 * モーションをランダムで再生する
 */
L2dModel.prototype.startRandomMotion = function(name, priority)
{
 ...
 */
L2dModel.prototype.startMotion = function(name, no, priority)
{
    ...
    if (priority == L2dDefine.PRIORITY_FORCE) 
    {
...
L2dModel.prototype.setFadeInFadeOut = function(name, no, priority, motion)
{
    var motionName = this.modelSetting.getMotionFile(name, no);
 ...
 * 表情を設定する
 */
L2dModel.prototype.setExpression = function(name)
{
 ...
 * 描画
 */
L2dModel.prototype.draw = function(gl)
{
    //console.log("--> L2dModel.draw()");
 ...
 */
L2dModel.prototype.hitTest = function(id, testX, testY)
{
